...
#path_light_data = curr_path + '/FF59_2104_Door_Event_RL_Adapted.txt'; light_divider = 0.7
#path_light_data = curr_path + '/B3_2140_Stairs1F_Event_Battery_Adapted.txt'; light_divider = 1
